...
[What is an awesome list?](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 507,042 | 🐛 106 | 📅 2026-09-02
...
* [github](https://github.com/zephyrproject-rtos) - Project GitHub organization.
  * [zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,552 | 🐛 3,935 | 🌐 C | 📅 2026-09-17 - Main repo.
  ...
  * [example-application](https://github.com/zephyrproject-rtos/example-application) ⭐ 361 | 🐛 3 | 🌐 C | 📅 2026-09-14 - Example out-of-tree application that is also a module.
...
* [Eclipse hawkbit](https://github.com/eclipse/hawkbit) ⭐ 596 | 🐛 65 | 🌐 Java | 📅 2026-09-17 - Firmware Update Server.
* [Memfault](https://github.com/memfault/memfault-firmware-sdk/tree/master/ports/zephyr) ⭐ 237 | 🐛 7 | 🌐 C | 📅 2026-09-02 - Cloud-based debugging & observability.
...
* [micropython](https://github.com/micropython/micropython) ⭐ 22,069 | 🐛 1,533 | 🌐 C | 📅 2026-09-16 - a lean and efficient Python implementation for microcontrollers and constrained systems.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,103 | 🐛 603 | 🌐 C | 📅 2026-09-17 - Lightweight standalone WebAssembly (WASM) runtime.
* [lispBM](https://github.com/svenssonjoel/lispBM) ⭐ 134 | 🐛 3 | 🌐 C | 📅 2026-09-16 - LispBM is a lisp or scheme like programming language for microcontrollers.

### Networking & Protocols

* [pjon](https://github.com/gioblu/PJON) ⭐ 2,824 | 🐛 60 | 🌐 C++ | 📅 2025-11-21 - Multi-master, multi-media network protocol.
* [BACnet Stack](https://github.com/bacnet-stack/bacnet-stack) ⭐ 596 | 🐛 94 | 🌐 C | 📅 2026-09-16 - BACnet open source protocol stack for embedded systems, Linux, and Windows.
* [openthread](https://github.com/zephyrproject-rtos/openthread) ⭐ 32 | 🐛 1 | 🌐 C++ | 📅 2026-09-16 - Thread mesh networking protocol.
* [canopennode](https://github.com/zephyrproject-rtos/canopennode) ⭐ 13 | 🐛 1 | 🌐 C | 📅 2026-04-07 - CANopen Stack.
* [Xaloqi EDS](https://github.com/Xaloqi/EDS) ⭐ 12 | 🐛 9 | 🌐 C | 📅 2026-09-14 - ISO 14229 (UDS) diagnostics stack with ISO-TP and DoIP transports, ASIL-B safety wrappers, and YAML-driven code generation for CAN-capable boards.
...
* [CBOR](https://cbor.io/) - Concise Binary Object Representation.
  ...
  * [zcbor](https://github.com/NordicSemiconductor/zcbor/) ⭐ 166 | 🐛 30 | 🌐 C | 📅 2026-09-17 - CBOR library that includes support for CDDL.
...
* [TF - M](https://github.com/zephyrproject-rtos/trusted-firmware-m) ⭐ 50 | 🐛 3 | 🌐 C | 📅 2026-09-17 - Platform Security Architecture (PSA) for ARMv7-M and Armv8-M.
* [MCUboot](https://github.com/zephyrproject-rtos/mcuboot) ⭐ 43 | 🐛 1 | 🌐 C | 📅 2026-09-16 - A secure bootloader for 32-bits microcontrollers.
...
* [zmk](https://github.com/zmkfirmware/zmk) ⭐ 4,267 | 🐛 427 | 🌐 C | 📅 2026-09-15 - Keyboard firmware with a rich featureset and broad hardware support.
* [zephyr-rust](https://github.com/tylerwhall/zephyr-rust) ⭐ 278 | 🐛 9 | 🌐 Rust | 📅 2026-09-17 - API bindings, libstd, and Cargo integration for Rust.
...
* [mcumgr](https://github.com/zephyrproject-rtos/mcumgr) ⭐ 35 | 🐛 0 | 🌐 C | 📅 2022-11-16
  ...
  * [Android](https://github.com/NordicSemiconductor/Android-nRF-Connect-Device-Manager) ⭐ 146 | 🐛 18 | 🌐 Java | 📅 2026-09-09
...
* [QEMU](https://github.com/zephyrproject-rtos/qemu) ⭐ 11 | 🐛 0 | 🌐 C | 📅 2026-07-28
  * [Network Tools](https://github.com/zephyrproject-rtos/net-tools) ⭐ 48 | 🐛 8 | 🌐 C | 📅 2026-08-07
...
* [ZMK](https://github.com/zmkfirmware/zmk) ⭐ 4,267 | 🐛 427 | 🌐 C | 📅 2026-09-15 - ZMK Firmware is an open source (MIT) keyboard firmware built on the Zephyr™ Project Real Time Operating System (RTOS).
