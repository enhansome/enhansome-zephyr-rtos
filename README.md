...
[What is an awesome list?](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 504,158 | 🐛 106 | 📅 2026-09-02

> \[!NOTE]\
> The Zephyr Project has started to maintain an [awesome list](https://github.com/zephyrproject-rtos/awesome-zephyr-rtos) ⭐ 70 | 🐛 4 | 📅 2026-02-24. We encourage you to check it out and contribute.
...
* [github](https://github.com/zephyrproject-rtos) - Project GitHub organization.
  * [zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,446 | 🐛 3,846 | 🌐 C | 📅 2026-09-08 - Main repo.
  * [west](https://github.com/zephyrproject-rtos/west) ⭐ 366 | 🐛 73 | 🌐 Python | 📅 2026-09-01 - Swiss-army knife command line tool.
  * [sdk-ng](https://github.com/zephyrproject-rtos/sdk-ng) ⭐ 290 | 🐛 83 | 🌐 C | 📅 2026-09-04 - Next generation toolchains & host tools.
  * [example-application](https://github.com/zephyrproject-rtos/example-application) ⭐ 360 | 🐛 2 | 🌐 C | 📅 2026-08-10 - Example out-of-tree application that is also a module.
  * [docker-image](https://github.com/zephyrproject-rtos/docker-image) ⭐ 246 | 🐛 12 | 🌐 Shell | 📅 2026-07-30 - Docker image suitable for development and CI.
...
* [Swedish Embedded Platform SDK](https://github.com/swedishembedded/sdk) ⭐ 71 | 🐛 4 | 🌐 JavaScript | 📅 2023-08-13 - Swedish Embedded Platform SDK is a comprehensive platform for firmware development.
...
* [ocre](https://github.com/project-ocre/ocre-runtime) ⭐ 143 | 🐛 17 | 🌐 C | 📅 2026-05-26 - OCI compliant application container runtime.
...
* [fats](https://github.com/zephyrproject-rtos/fatfs) ⭐ 18 | 🐛 1 | 🌐 C | 📅 2026-08-28 - Generic FAT/exFAT filesystem module for small embedded systems.
* [nffs](https://github.com/zephyrproject-rtos/nffs) ⚠️ Archived - Flash file system prioritizing minimal ram usage & reliability.

### HAL/PAL

* [libmetal](https://github.com/zephyrproject-rtos/libmetal) ⭐ 17 | 🐛 0 | 🌐 C | 📅 2026-08-28 - Abstraction layer across user-space Linux, baremetal, and RTOS environments.
* [cmsis](https://github.com/zephyrproject-rtos/cmsis) ⭐ 16 | 🐛 2 | 🌐 C | 📅 2025-06-03 - Standardized API for the Cortex-M processor core and peripherals.

### IoT & Cloud

* [Eclipse hawkbit](https://github.com/eclipse/hawkbit) ⭐ 595 | 🐛 65 | 🌐 Java | 📅 2026-09-08 - Firmware Update Server.
* [Memfault](https://github.com/memfault/memfault-firmware-sdk/tree/master/ports/zephyr) ⭐ 236 | 🐛 5 | 🌐 C | 📅 2026-09-02 - Cloud-based debugging & observability.
...
* [send-my-sensor](https://github.com/koenvervloesem/send-my-sensor) ⭐ 29 | 🐛 1 | 🌐 C | 📅 2022-06-10 - Upload sensor data from a device without internet connection by (ab)using Apple's Find My network.
* [thingset-zephyr-sdk](https://github.com/ThingSet/thingset-zephyr-sdk) ⭐ 22 | 🐛 8 | 🌐 C | 📅 2026-04-16 - A software development kit (SDK) based on Zephyr RTOS to integrate communication interfaces using the ThingSet protocol into an application with minimum effort. See <https://thingset.io/>.
...
* [micropython](https://github.com/micropython/micropython) ⭐ 22,050 | 🐛 1,522 | 🌐 C | 📅 2026-09-08 - a lean and efficient Python implementation for microcontrollers and constrained systems.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,085 | 🐛 605 | 🌐 C | 📅 2026-09-07 - Lightweight standalone WebAssembly (WASM) runtime.
* [lispBM](https://github.com/svenssonjoel/lispBM) ⭐ 134 | 🐛 3 | 🌐 C | 📅 2026-09-06 - LispBM is a lisp or scheme like programming language for microcontrollers.

### Networking & Protocols

* [pjon](https://github.com/gioblu/PJON) ⭐ 2,824 | 🐛 60 | 🌐 C++ | 📅 2025-11-21 - Multi-master, multi-media network protocol.
* [BACnet Stack](https://github.com/bacnet-stack/bacnet-stack) ⭐ 593 | 🐛 91 | 🌐 C | 📅 2026-09-07 - BACnet open source protocol stack for embedded systems, Linux, and Windows.
* [openthread](https://github.com/zephyrproject-rtos/openthread) ⭐ 31 | 🐛 0 | 🌐 C++ | 📅 2026-09-08 - Thread mesh networking protocol.
* [canopennode](https://github.com/zephyrproject-rtos/canopennode) ⭐ 13 | 🐛 1 | 🌐 C | 📅 2026-04-07 - CANopen Stack.
* [Xaloqi EDS](https://github.com/Xaloqi/EDS) ⭐ 11 | 🐛 9 | 🌐 C | 📅 2026-09-07 - ISO 14229 (UDS) diagnostics stack with ISO-TP and DoIP transports, ASIL-B safety wrappers, and YAML-driven code generation for CAN-capable boards.
...
* [CBOR](https://cbor.io/) - Concise Binary Object Representation.
  * [QCBOR](https://github.com/laurencelundblade/QCBOR) ⭐ 240 | 🐛 26 | 🌐 C | 📅 2026-09-07 - Comprehensive CBOR library.
  * [zcbor](https://github.com/NordicSemiconductor/zcbor/) ⭐ 166 | 🐛 31 | 🌐 C | 📅 2026-09-03 - CBOR library that includes support for CDDL.
...
* [TF - M](https://github.com/zephyrproject-rtos/trusted-firmware-m) ⭐ 50 | 🐛 8 | 🌐 C | 📅 2026-09-02 - Platform Security Architecture (PSA) for ARMv7-M and Armv8-M.
* [MCUboot](https://github.com/zephyrproject-rtos/mcuboot) ⭐ 43 | 🐛 1 | 🌐 C | 📅 2026-09-03 - A secure bootloader for 32-bits microcontrollers.
...
* [zmk](https://github.com/zmkfirmware/zmk) ⭐ 4,250 | 🐛 422 | 🌐 C | 📅 2026-09-07 - Keyboard firmware with a rich featureset and broad hardware support.
...
* [zscilib](https://github.com/zephyrproject-rtos/zscilib) ⭐ 166 | 🐛 21 | 🌐 C | 📅 2026-08-26 - Scientific computing library.
...
* [lvgl](https://github.com/zephyrproject-rtos/lvgl) ⭐ 87 | 🐛 7 | 🌐 C | 📅 2026-09-01 - Complete graphics library.
...
* [Zephyr Container Images](https://github.com/embeddedcontainers/zephyr) ⭐ 78 | 🐛 3 | 🌐 Dockerfile | 📅 2026-08-13 - Develop Zephyr applications using OCI-compatible Docker images.
* [action-setup-zephyr](https://github.com/zephyrproject-rtos/action-zephyr-setup) ⭐ 31 | 🐛 6 | 📅 2026-09-04 - This action initializes a Zephyr based project, downloading the Zephyr SDK and the necessary modules for a West based [Zephyr workspace application](https://docs.zephyrproject.org/latest/develop/application/index.html#zephyr-workspace-app).
...
* [zephyr-ide](https://github.com/mylonics/zephyr-ide) ⭐ 98 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-26 - The Zephyr IDE for VS code extension provides tools to aide in your Zephyr Project work flow.
...
* [OpenOCD](https://github.com/zephyrproject-rtos/openocd) ⭐ 46 | 🐛 8 | 🌐 C | 📅 2026-09-02
...
* [mcumgr](https://github.com/zephyrproject-rtos/mcumgr) ⭐ 35 | 🐛 0 | 🌐 C | 📅 2022-11-16
  * [iOS](https://github.com/NordicSemiconductor/IOS-nRF-Connect-Device-Manager) ⭐ 164 | 🐛 2 | 🌐 Swift | 📅 2026-09-07
  * [Android](https://github.com/NordicSemiconductor/Android-nRF-Connect-Device-Manager) ⭐ 145 | 🐛 20 | 🌐 Java | 📅 2026-08-26
  * [Web](https://github.com/boogie/mcumgr-web) ⭐ 64 | 🐛 3 | 🌐 JavaScript | 📅 2026-06-18
* [Aerology](https://github.com/Linaro/aerology) ⭐ 25 | 🐛 2 | 🌐 Rust | 📅 2025-01-24 - Inspect Zephyr and TF-M applications, post mortem.
...
* [QEMU](https://github.com/zephyrproject-rtos/qemu) ⭐ 11 | 🐛 0 | 🌐 C | 📅 2026-07-28
  * [Network Tools](https://github.com/zephyrproject-rtos/net-tools) ⭐ 47 | 🐛 8 | 🌐 C | 📅 2026-08-07
...
* [ZMK](https://github.com/zmkfirmware/zmk) ⭐ 4,250 | 🐛 422 | 🌐 C | 📅 2026-09-07 - ZMK Firmware is an open source (MIT) keyboard firmware built on the Zephyr™ Project Real Time Operating System (RTOS).
* [ZSWatch](https://github.com/jakkra/ZSWatch) ⭐ 83 | 🐛 0 | 🌐 C | 📅 2026-08-30 - The Open Source Zephyr™ based Smartwatch, including both HW and FW.
...
* [Tutorial for Beginners](https://github.com/maksimdrachov/zephyr-rtos-tutorial) ⭐ 474 | 🐛 10 | 🌐 C | 📅 2024-04-07
