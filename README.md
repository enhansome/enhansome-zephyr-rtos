...
[What is an awesome list?](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 504,455 | 🐛 106 | 📅 2026-09-02
...
* [github](https://github.com/zephyrproject-rtos) - Project GitHub organization.
  * [zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,457 | 🐛 3,818 | 🌐 C | 📅 2026-09-09 - Main repo.
  * [west](https://github.com/zephyrproject-rtos/west) ⭐ 366 | 🐛 75 | 🌐 Python | 📅 2026-09-01 - Swiss-army knife command line tool.
  * [sdk-ng](https://github.com/zephyrproject-rtos/sdk-ng) ⭐ 290 | 🐛 82 | 🌐 C | 📅 2026-09-08 - Next generation toolchains & host tools.
  * [example-application](https://github.com/zephyrproject-rtos/example-application) ⭐ 361 | 🐛 2 | 🌐 C | 📅 2026-08-10 - Example out-of-tree application that is also a module.
...
* [chre](https://github.com/zephyrproject-rtos/chre) ⭐ 11 | 🐛 2 | 🌐 C++ | 📅 2026-03-13 - Context Hub Runtime Environment (CHRE) is Android’s platform for developing always-on applications, called nanoapps.
...
* [Eclipse hawkbit](https://github.com/eclipse/hawkbit) ⭐ 595 | 🐛 65 | 🌐 Java | 📅 2026-09-09 - Firmware Update Server.
* [Memfault](https://github.com/memfault/memfault-firmware-sdk/tree/master/ports/zephyr) ⭐ 236 | 🐛 6 | 🌐 C | 📅 2026-09-02 - Cloud-based debugging & observability.
...
* [micropython](https://github.com/micropython/micropython) ⭐ 22,052 | 🐛 1,523 | 🌐 C | 📅 2026-09-09 - a lean and efficient Python implementation for microcontrollers and constrained systems.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,086 | 🐛 605 | 🌐 C | 📅 2026-09-07 - Lightweight standalone WebAssembly (WASM) runtime.
...
* [BACnet Stack](https://github.com/bacnet-stack/bacnet-stack) ⭐ 593 | 🐛 93 | 🌐 C | 📅 2026-09-09 - BACnet open source protocol stack for embedded systems, Linux, and Windows.
...
* [CBOR](https://cbor.io/) - Concise Binary Object Representation.
  ...
  * [zcbor](https://github.com/NordicSemiconductor/zcbor/) ⭐ 166 | 🐛 35 | 🌐 C | 📅 2026-09-03 - CBOR library that includes support for CDDL.
...
* [TF - M](https://github.com/zephyrproject-rtos/trusted-firmware-m) ⭐ 50 | 🐛 6 | 🌐 C | 📅 2026-09-09 - Platform Security Architecture (PSA) for ARMv7-M and Armv8-M.
* [MCUboot](https://github.com/zephyrproject-rtos/mcuboot) ⭐ 43 | 🐛 1 | 🌐 C | 📅 2026-09-08 - A secure bootloader for 32-bits microcontrollers.
...
* [zmk](https://github.com/zmkfirmware/zmk) ⭐ 4,251 | 🐛 425 | 🌐 C | 📅 2026-09-09 - Keyboard firmware with a rich featureset and broad hardware support.
...
* [zephyr-ide](https://github.com/mylonics/zephyr-ide) ⭐ 99 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-26 - The Zephyr IDE for VS code extension provides tools to aide in your Zephyr Project work flow.
...
* [mcumgr](https://github.com/zephyrproject-rtos/mcumgr) ⭐ 35 | 🐛 0 | 🌐 C | 📅 2022-11-16
  ...
  * [Android](https://github.com/NordicSemiconductor/Android-nRF-Connect-Device-Manager) ⭐ 145 | 🐛 18 | 🌐 Java | 📅 2026-09-09
...
* [ZMK](https://github.com/zmkfirmware/zmk) ⭐ 4,251 | 🐛 425 | 🌐 C | 📅 2026-09-09 - ZMK Firmware is an open source (MIT) keyboard firmware built on the Zephyr™ Project Real Time Operating System (RTOS).
