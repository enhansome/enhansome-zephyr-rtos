...
[What is an awesome list?](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 502,273 | 🐛 105 | 📅 2026-09-02
...
* [github](https://github.com/zephyrproject-rtos) - Project GitHub organization.
  * [zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,380 | 🐛 3,897 | 🌐 C | 📅 2026-09-02 - Main repo.
  * [west](https://github.com/zephyrproject-rtos/west) ⭐ 363 | 🐛 72 | 🌐 Python | 📅 2026-09-01 - Swiss-army knife command line tool.
  * [sdk-ng](https://github.com/zephyrproject-rtos/sdk-ng) ⭐ 289 | 🐛 83 | 🌐 C | 📅 2026-08-03 - Next generation toolchains & host tools.
...
* [Eclipse hawkbit](https://github.com/eclipse/hawkbit) ⭐ 595 | 🐛 63 | 🌐 Java | 📅 2026-09-01 - Firmware Update Server.
* [Memfault](https://github.com/memfault/memfault-firmware-sdk/tree/master/ports/zephyr) ⭐ 236 | 🐛 5 | 🌐 C | 📅 2026-08-28 - Cloud-based debugging & observability.
...
* [micropython](https://github.com/micropython/micropython) ⭐ 22,038 | 🐛 1,532 | 🌐 C | 📅 2026-09-02 - a lean and efficient Python implementation for microcontrollers and constrained systems.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,083 | 🐛 608 | 🌐 C | 📅 2026-09-02 - Lightweight standalone WebAssembly (WASM) runtime.
* [lispBM](https://github.com/svenssonjoel/lispBM) ⭐ 132 | 🐛 3 | 🌐 C | 📅 2026-09-01 - LispBM is a lisp or scheme like programming language for microcontrollers.

### Networking & Protocols

* [pjon](https://github.com/gioblu/PJON) ⭐ 2,816 | 🐛 60 | 🌐 C++ | 📅 2025-11-21 - Multi-master, multi-media network protocol.
* [BACnet Stack](https://github.com/bacnet-stack/bacnet-stack) ⭐ 592 | 🐛 93 | 🌐 C | 📅 2026-09-02 - BACnet open source protocol stack for embedded systems, Linux, and Windows.
...
* [CBOR](https://cbor.io/) - Concise Binary Object Representation.
  ...
  * [zcbor](https://github.com/NordicSemiconductor/zcbor/) ⭐ 166 | 🐛 32 | 🌐 C | 📅 2026-08-20 - CBOR library that includes support for CDDL.
...
* [MCUboot](https://github.com/zephyrproject-rtos/mcuboot) ⭐ 43 | 🐛 1 | 🌐 C | 📅 2026-08-21 - A secure bootloader for 32-bits microcontrollers.
...
* [zmk](https://github.com/zmkfirmware/zmk) ⭐ 4,246 | 🐛 419 | 🌐 C | 📅 2026-08-31 - Keyboard firmware with a rich featureset and broad hardware support.
...
* [mcumgr](https://github.com/zephyrproject-rtos/mcumgr) ⭐ 35 | 🐛 0 | 🌐 C | 📅 2022-11-16
  * [iOS](https://github.com/NordicSemiconductor/IOS-nRF-Connect-Device-Manager) ⭐ 164 | 🐛 2 | 🌐 Swift | 📅 2026-09-01
...
* [ZMK](https://github.com/zmkfirmware/zmk) ⭐ 4,246 | 🐛 419 | 🌐 C | 📅 2026-08-31 - ZMK Firmware is an open source (MIT) keyboard firmware built on the Zephyr™ Project Real Time Operating System (RTOS).
* [ZSWatch](https://github.com/jakkra/ZSWatch) ⭐ 82 | 🐛 0 | 🌐 C | 📅 2026-08-30 - The Open Source Zephyr™ based Smartwatch, including both HW and FW.
