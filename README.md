...
[What is an awesome list?](https://github.com/sindresorhus/awesome/blob/main/awesome.md) ⭐ 504,726 | 🐛 106 | 📅 2026-09-02
...
* [github](https://github.com/zephyrproject-rtos) - Project GitHub organization.
  * [zephyr](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,472 | 🐛 3,832 | 🌐 C | 📅 2026-09-10 - Main repo.
...
* [Eclipse hawkbit](https://github.com/eclipse/hawkbit) ⭐ 595 | 🐛 66 | 🌐 Java | 📅 2026-09-09 - Firmware Update Server.
...
* [micropython](https://github.com/micropython/micropython) ⭐ 22,054 | 🐛 1,525 | 🌐 C | 📅 2026-09-09 - a lean and efficient Python implementation for microcontrollers and constrained systems.
* [wasm-micro-runtime](https://github.com/bytecodealliance/wasm-micro-runtime) ⭐ 6,086 | 🐛 600 | 🌐 C | 📅 2026-09-10 - Lightweight standalone WebAssembly (WASM) runtime.
...
* [BACnet Stack](https://github.com/bacnet-stack/bacnet-stack) ⭐ 594 | 🐛 93 | 🌐 C | 📅 2026-09-10 - BACnet open source protocol stack for embedded systems, Linux, and Windows.
...
* [Xaloqi EDS](https://github.com/Xaloqi/EDS) ⭐ 11 | 🐛 9 | 🌐 C | 📅 2026-09-10 - ISO 14229 (UDS) diagnostics stack with ISO-TP and DoIP transports, ASIL-B safety wrappers, and YAML-driven code generation for CAN-capable boards.
...
* [TF - M](https://github.com/zephyrproject-rtos/trusted-firmware-m) ⭐ 50 | 🐛 5 | 🌐 C | 📅 2026-09-10 - Platform Security Architecture (PSA) for ARMv7-M and Armv8-M.
...
* [zmk](https://github.com/zmkfirmware/zmk) ⭐ 4,252 | 🐛 430 | 🌐 C | 📅 2026-09-10 - Keyboard firmware with a rich featureset and broad hardware support.
...
* [zephyr-ide](https://github.com/mylonics/zephyr-ide) ⭐ 99 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-10 - The Zephyr IDE for VS code extension provides tools to aide in your Zephyr Project work flow.
...
* [ZMK](https://github.com/zmkfirmware/zmk) ⭐ 4,252 | 🐛 430 | 🌐 C | 📅 2026-09-10 - ZMK Firmware is an open source (MIT) keyboard firmware built on the Zephyr™ Project Real Time Operating System (RTOS).
